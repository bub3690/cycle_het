...
#from modules.model import CNN, Hybrid
from modules.dataset import SeverityDataset,SeverityDataset_cycle
from modules.cycle_trainer import train_cycle

from modules.utils import cosine_scheduler
...
def main(args):
    ...
    for dataset in dataset_list:
        ...
        # dataset 만들기.
        train_dataset = SeverityDataset_cycle(filename_list=train_data,
    ...
    if args.pretrained != None:
        ...
        teacher = load_pretrained_model_without_omni_heads(teacher, args.pretrained)
    ###
    ...
    if args.ema_mode == "epoch":
        ...
        iters_per_epoch = 0
        for d in train_data_loader_list:
    ...
    for epoch in range(EPOCHS):
        ...
        for head_n in range( len(num_regions_list) ):
            ...
            train_loss, train_acc, train_mae, train_consistency = train_cycle(args, model, num_classes_list[head_n], num_regions_list[head_n], head_n,
                                                     args.ema_mode, teacher, momentum_schedule, coef_schedule, it,
                                                     EPOCHS, epoch, 
            ...
            wandb.log({
                ...
                f"{dataset_list[head_n]} Train MAE": train_mae,
                f"{dataset_list[head_n]} Valid MAE": valid_mae,
                
                f"{dataset_list[head_n]} Train Consistency": train_consistency
            })            
...
if __name__ == '__main__':
    ...
    ###
    # ARK
    parser.add_argument("--ema_mode", dest="ema_mode", default="epoch", help="update teacher model at which time (epoch | iteration)", type=str)
    parser.add_argument('--momentum_teacher', default=0.9, type=float, help="""Base EMA
        parameter for teacher update. The value is increased to 1 during training with cosine schedule.
        We recommend setting a higher value with small batches: for example use 0.9995 with batch size of 256.""")
    parser.add_argument("--pretrain_epochs", dest="pretrain_epochs", help="num of omni-pretraining epoches", default=50, type=int)
